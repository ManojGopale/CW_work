...
class Data:
	...
	def getStdParam(self, x_data):
		...
		x_data_mean.to_csv("/xdisk/ditzler/manojgopale/extra/keyPrediction_chip/scr/moreDataTrials/result/summaryStats/mean_20000perkey.csv", index=False, header=False)
		x_data_std.to_csv("/xdisk/ditzler/manojgopale/extra/keyPrediction_chip/scr/moreDataTrials/result/summaryStats/std_20000perkey.csv", index=False, header=False)
